import type { WalletClient, PublicClient, Address, Account, Hash, TransactionReceipt, WaitForTransactionReceiptParameters, Chain } from 'viem';
...
export type NoCallback<TProps extends {
    callback?: TransactionCallback;
