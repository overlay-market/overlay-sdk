...
import { OpenPositionsQuery, UnwindsQuery, LiquidatedPositionsQuery, NumberOfPositionsQuery, QueryPositionQuery } from "./types";
...
export declare const getNumberOfPositions: (chainId: CHAINS, account: string) => Promise<NumberOfPositionsQuery | undefined>;
export declare const getPositionDetails: (chainId: CHAINS, account: string, marketPositionId: string) => Promise<QueryPositionQuery | undefined>;
export {};
