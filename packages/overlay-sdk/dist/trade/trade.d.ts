...
import { TradeState, UnwindStateData } from "./types";
export declare class OverlaySDKTrade extends OverlaySDKModule {
    ...
    getUnwindState(marketAddress: Address, account: Address, posId: number, unwindPercentage: number, // 0.01 - 1
    slippage: number, decimals?: number): Promise<UnwindStateData>;
}
